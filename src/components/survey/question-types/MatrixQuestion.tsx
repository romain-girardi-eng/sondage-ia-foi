  ...
  return (
    <fieldset className="border-0">
      ...
      <div className="space-y-4 pb-4">
        ...
        <div className="hidden md:grid md:grid-cols-[1fr,repeat(4,80px)] gap-2 items-end pb-2 border-b border-border/50">
          ...
          {matrixCols.map((col, idx) => (
            ...
            >
              <span className="text-xs text-muted-foreground font-medium leading-tight block px-1">
