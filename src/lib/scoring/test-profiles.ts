...
const MOCK_SCENARIOS: MockScenario[] = [
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      psych_anthropomorphisme: 'impossible',
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      min_pred_nature: ['plan', 'exegese', 'illustration'],
      min_pred_sentiment: 2,
      min_care_email: 'oui_souvent',
      min_admin_burden: 5,
      psych_anthropomorphisme: 'possible',
      psych_imago_dei: 'peu',
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      psych_anthropomorphisme: 'peu_probable',
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      psych_anthropomorphisme: 'incertain',
      psych_imago_dei: 'beaucoup',
      psych_anxiete_remplacement: 'possible_partiel',
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      min_pred_nature: ['plan', 'illustration'],
      min_pred_sentiment: 2,
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      digital_attitude_generale: 'positif',
      min_pred_usage: 'regulier',
      min_pred_nature: ['exegese', 'illustration'],
      min_pred_sentiment: 2,
      min_care_email: 'oui_brouillon',
      min_admin_burden: 4,
      psych_anthropomorphisme: 'peu_probable',
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      psych_anthropomorphisme: 'ne_sait_pas',
...
function runTests() {
  ...
  let correct = 0;
  let total = MOCK_SCENARIOS.length;
