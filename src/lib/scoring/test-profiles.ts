...
const MOCK_SCENARIOS: MockScenario[] = [
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      min_pred_nature: { plan: 2, exegese: 1, illustration: 1, redaction: 0 },
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      min_pred_nature: { plan: 2, exegese: 0, illustration: 2, redaction: 0 },
      min_pred_sentiment: 2,
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      digital_attitude_generale: 'positif',
      min_pred_usage: 'regulier',
      min_pred_nature: { plan: 0, exegese: 2, illustration: 1, redaction: 0 },
      min_pred_sentiment: 2,
      min_care_email: 'oui_brouillon',
      min_admin_burden: 4,
      psych_godspeed_nature: '2_machine_plus',
  ...
  // ==========================================
  {
    ...
    answers: {
      ...
      digital_attitude_generale: 'neutre',
      min_pred_usage: 'rare',
      min_pred_nature: { plan: 0, exegese: 0, illustration: 1, redaction: 0 },
